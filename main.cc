...
// ── H-SCL: declare the globals defined in upscaledb.cc ───────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Callable — worker thread object
// H-SCL: hfairlock_thread_init is called at the START of operator() so it
// runs in the thread's own context (required by pthread_setspecific).
// Thread IDs 1..N-1 go here. Thread 0 is initialised in run_single_test().
...
// ─────────────────────────────────────────────────────────────────────────────
// run_single_test — H-SCL lock init + thread-0 init injected here
// ─────────────────────────────────────────────────────────────────────────────
